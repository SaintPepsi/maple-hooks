...
export function findExportDefaults(lines: string[], filePath?: string, additionalExclusions?: readonly RegExp[]): Violation[] {
  if (filePath) {
...
export function findAllViolations(content: string, filePath?: string, options?: ViolationCheckOptions): Violation[] {
