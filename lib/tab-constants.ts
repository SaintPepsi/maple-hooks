...
> = {
  OBSERVE: {
    ...
    inactiveBg: "#0C2D48",
    label: "observe",
    gerund: "Observing the user request.",
  },
  THINK: {
    symbol: "🧠",
    inactiveBg: "#2D1B69",
    label: "think",
    gerund: "Analyzing the problem space.",
  },
  PLAN: {
    symbol: "📋",
    inactiveBg: "#1E1B4B",
    label: "plan",
    gerund: "Planning the execution approach.",
  },
  BUILD: {
    symbol: "🔨",
    inactiveBg: "#78350F",
    label: "build",
    gerund: "Building the solution artifacts.",
  },
  EXECUTE: {
    symbol: "⚡",
    inactiveBg: "#713F12",
    label: "execute",
    gerund: "Executing the planned work.",
  },
  VERIFY: {
    symbol: "✅",
    inactiveBg: "#14532D",
    label: "verify",
    gerund: "Verifying ideal state criteria.",
  },
  LEARN: {
    symbol: "📚",
    inactiveBg: "#134E4A",
    label: "learn",
    gerund: "Recording the session learnings.",
  },
